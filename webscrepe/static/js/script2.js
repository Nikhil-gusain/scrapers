            ...
            function p(l, p, _, b) {
                ...
                if (y || (y = {
                    ...
                    if (void 0 === l.jivo_magic_var) {
                        ...
                        var S, j, C, I, L, E, T, N, O, B, A = {
                            ...
                            G = !0;
                        ye("Initialization"), l.__jivoBundleOnLoad = function (e) {
                            clearTimeout(I), L = e;
                            var t = ((new Date).getTime() - E) / 1e3;
                            t > 6 && de("loadTime", t);
                            de("bundleLoaded", !0), de("buildNumber", S.build_number), ye("Bundle is loaded"),
                                function () {
                        ...
                        }, A.getHostURL = be, A.store = q, A.setInStore = de;
                        var V, X = !1,
                            F = function (e) {
                                try {
                        ...
                        ue(), !(!(V = N) || (!/^\d+$/.test(V) || 0 === V) && 10 != V.length) || (N = null, T = null, y.error("Widget id is not valid.")), T || (N = null, T = null, y.error("Widget codehost is not valid")), Q(f, 5),
                            function () {
                ...
                function $(e, t) {
                    if (U.push(e), ++D > 4) {
                        ...
                        l.__jivoOnError(n)
                    } else if (ye("Loading config from", e), q.deletedInfo.widgetId && q.deletedInfo.widgetId === N && q.deletedInfo.resolveTime && parseInt(q.deletedInfo.resolveTime) >= (new Date).getTime()) y.error("This widget is permanently removed.");
                                        ...
                                        n.onreadystatechange = function () {
                                            if (4 === n.readyState)
                                                if (200 === n.status) {
                                                    ...
                                                    ye("Status is loaded", o, r, i, a), e.lastStatus = o, e.botmode = "yes" === r ? "yes" : null, e.geoip = i || ";;;", e.chat_mode = a ? "online" : "offline", e.options = o.premium ? 888 : 0, o.bots && o.bots.length && (e.bots = o.bots), e.maintenance = !!o.maintenance, t(o.config_updated_ts)
                                                } else if (0 !== n.status) {
                                                    if (404 == n.status) return void me();
                                                    throw e.botmode = null, e.geoip = ";;;", e.chat_mode = "offline", e.options = 0, t(null), 480 == n.status && (e.maintenance = !0, ye("Site is under maintenance, try again later.")), new Error("Load widget status error: " + n.status)
                                                }
                                        };
                ...
                function K(e) {
                    ...
                    if (u() && l.navigator && l.navigator.sendBeacon) try {
                        var n = a(),
                            o = r();
                ...
                function ee(e, t) {
                    if (ye("checkConfig", e.config_updated_ts, t), e.isDeleted) me();
                        ...
                        if ((Z = e.ab_segment) && Z.name && Z.host && Z.staticHost && 1 !== e.site_id)
                            if (ye("AB-testing segmentation is enabled in config"), Y = function (e, t) {
                                var n = q.abTesting,
                                    o = !1;
                        ...
                        ! function (e) {
                            if (de("log", !!e.logs), l.jivo_config = S = e, function () {
                                if (S.host_blacklist)
                                    for (var e = S.host_blacklist.split(","), t = 0; t < e.length; t++)
                                        if (l.location.host.indexOf(e[t].replace(" ", "")) >= 0) return !0;
                                return !1
                            ...
                            if (!e.disable_stop_words && function () {
                                ...
                                var d;
                                (r && _e(r, t) || i && _e(i, t) || a && _e(a, t)) && (e = !0);
                                return e
                            }()) return K(v), void ye("Init error, code 1015.");
                            if (W && S.disable_mobile) return void ye("Mobile widget is disabled");
                            var t;
                            "complete" == p.readyState ? (ye("DOM Ready Complete."), te()) : q.bundleLoaded && q.buildNumber == S.build_number ? (ye("DOM Ready is not complete. Bundle loaded and BuildNumber is correct."), "interactive" == p.readyState ? (ye("DOM Ready is interactive. Bundle loaded and BuildNumber is correct."), te()) : (ye("DOM Ready is not interactive. Bundle loaded and BuildNumber is correct. Add listener on DOMContentLoaded."), d(l, "DOMContentLoaded", te))) : (ye("DOM Ready is not complete. Bundle is not loaded. Add listener on window.onload"), de("bundleLoaded", !1), d(l, "load", te))
                        }(e)
                    }
                }
                ...
                function te() {
                    ye("Widget initialization"),
                        function () {
                            ye("Iframe initialization"), x.src = "", x.role = "presentation", x.allow = "autoplay", x.title = "Jivochat", x.setAttribute("name", "jivo_container"), x.setAttribute("id", "jivo_container"), x.setAttribute("frameborder", "no"), B && x.setAttribute("nonce", B);
                            ...
                            d(l, "message", (function (e) {
                                if (e && e.data && "object" == typeof e.data) {
                                    ...
                                    "in_node_webkit" == t.name && (l.jivo_cobrowse = {
                                        source: e.source,
                                        origin: e.origin
                                    }), "iframe_url_changed" != t.name && "iframe_url_changed" != t || ie()
                ...
                function re(e) {
                    ...
                    E = (new Date).getTime(), we(n), n.className = "js-jivo-bundle", n.src = r() + o, A.bundleSrc = o, n.onerror = function () {
                        ye("loadBundle errorBundle", e), p.getElementById("jcont") && function (e, t, n) {
                ...
                function ue() {
                    ...
                    if (A.scriptSrc = r, r && (r.match(/&lt;/) || r.match(/scr=/))) ye("Invalid codeHost", r);
                        ...
                        var i, a = t(r),
                            d = n(r),
                            s = o(r);
                        T || (a ? (T = "//" + a[1], J = !0) : d ? T = "//" + d[1] : s && (T = "//" + s[1])), N || (d && d[2] ? (N = d[2], J = !1) : s && s[2] ? (N = s[2], J = !1) : (J = !0, O && (N = O.getAttribute("jv-id") || O.getAttribute("data-jv-id")), N || (i = r && r.match(/https?:\/\/\S+\/widget\/([A-Za-z0-9]+)/), N = i ? i[1] : null))), w && (T = "//" + new URL(r).host), ye("getWidgetIdAndConfigHost", N, T)
                    }
                }
                ...
                function me() {
                    ye("Widget was removed", N), de("configHost", null), q.geoWidgetInfo.widgetId || q.isChatStarted ? (de("geoWidgetInfo", ge(null, null, null)), de("isChatStarted", null), he()) : (de("deletedInfo", {
                        widgetId: N,
                        resolveTime: ((new Date).getTime() + 864e5).toString()
                    }), y.error("Widget " + N + " is permanently removed. Host: " + T), K(h))
                }
                ...
                function _e(e, t) {
                    for (var n = !1, o = 0; o < t.length; o++) {
                        var r = t[o].toLowerCase(),
                            i = new RegExp("([, .]|^)" + r + "([, .]|$)", "gi");
                        if (e && e.toLowerCase && e.toLowerCase().search(i) > -1) {
                            n = !0;
                            break
                        }
                    }
